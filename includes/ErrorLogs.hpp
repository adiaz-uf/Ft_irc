...
#define ERR_NEEDMOREPARAMS(clientNick, command)                 (std::string("461 ") + (clientNick) + " " + (command) + " " + std::string(":") + "Not enough parameters" + "\r\n")
...
#define ERR_BADCHANNELKEY(clientNick, channel)                  (std::string(":") + (clientNick) + " PRIVMSG " + (channel) + " 475 " + (channel) + " :Cannot join channel (+k)\r\n")
